...
/opt/src/etcd/etcd --name etcd1 \
  ...
  --initial-cluster etcd1=https://192.168.181.194:2380,etcd2=https://172.31.205.45:2380,etcd3=https://172.31.205.46:2380 \
...
stdout_logfile=/opt/src/etcd/etcd.stdout.log                    ; stdout log path, NONE for none; default AUTO
stdout_logfile_maxbytes=64MB                                    ; max # logfile bytes b4 rotation (default 50MB)
stdout_logfile_backups=4                                        ; # of stdout logfile backups (default 10)
stdout_capture_maxbytes=1MB                                     ; number of bytes in 'capturemode' (default 0)
stdout_events_enabled=false                                     ; emit events on stdout writes (default false)
stderr_logfile=/opt/src/etcd/etcd.stderr.log                    ; stderr log path, NONE for none; default AUTO
...
etcd1: added process group
# 查看启动状态
supervisorctl status
etcd1                            RUNNING   pid 17299, uptime 0:00:27
```
